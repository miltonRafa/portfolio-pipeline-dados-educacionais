...
|---|---:|---|---|---|---|---|
| IDEB | 2007-2023 | `divulgacao_regioes_ufs_ideb_2023.xlsx` | não registrado no repositório | resultado agregado | workbook oficial que concentra a série histórica usada no projeto | não utilizado |
